class BinanceIndexAsset {
	constructor(name, coins, index_wrapper_id) {
		this.name = name;
		this.coins = coins;
		this.index_wrapper_id = index_wrapper_id;
	}

	async displayBinanceIndexAssetData(url) {
	...
	async createAssetDiv(data, parentDiv) {
		//console.log(data);
		//main div
		...
		nameDiv.addEventListener("click", () => {
			...
			const index_wrapper = document.getElementById(this.index_wrapper_id);
	...
	async getPriceTrendData(div, coin, url, coinIsTradedAgainstEuro) {
	...
	async createInfoDivs(indexDetailsDiv, data) {
	...
	async fillInfoDivWithCoinStatistics_Minute(div, coin) {
	...
	async fillInfoDivWithCoinStatistics_Hour(div, coin) {
	...
	async fillInfoDivWithCoinStatistics_Week(div, coin) {
	...
	async fillInfoDivWithCoinStatistics_Month(div, coin) {
	...
	async fillInfoDivWithIndexStatistics(div, indexLabel, interval) {
