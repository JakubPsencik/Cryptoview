var container10_2 = document.getElementById("container10_2");
...
var switcherElement = createSimpleSwitcher1(intervals, intervals[0], syncToInterval1);

var chartElement = document.createElement('div');

var chart1 = LightweightCharts.createChart(chartElement, {
	width: container10_2.offsetWidth,
	height: container10_2.offsetHeight-50,
	layout: {
		background: {
            type: 'solid',
            color: '#000000',
...
container10_2.appendChild(chartElement);
container10_2.appendChild(switcherElement);
...
function syncToInterval1(interval) {
	...
	areaSeries = chart1.addAreaSeries({
