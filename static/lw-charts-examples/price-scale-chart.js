var container10_4 = document.getElementById('container10_4');

var chart4 = LightweightCharts.createChart(container10_4, {
    width: container10_4.offsetWidth,
	height: container10_4.offsetHeight-50,
        layout: {
	...
	var series = chart4.addLineSeries({
		color: 'rgb(0, 120, 255)',
		lineWidth: 2,
  ...
  {time: { year: 2018 ,month: 12 ,day: 30 }, value: 29.567577074788517},
	...
	var priceLinesArray = [];
	priceLinesArray.push(minPriceLine);
	priceLinesArray.push(avgPriceLine);
	priceLinesArray.push(maxPriceLine);

	priceLinesArray.forEach(pline => {
		console.log(pline);
	});
	...
	//series.removePriceLine(minPriceLine);

	chart4.timeScale().fitContent();
	var bn = document.getElementById('price_bn');
	var bnr = document.getElementById('price_bn_r');
	//let priceLine = series.createPriceLine({ price: 80.0 });
	bn.onclick = function(){
		runTestCase();
		console.log('clicked');
		console.log(series.seriesType());
	};
	...
	bnr.onclick = function(){
        ...
        updateDiv();
        document.getElementById("#container10_4").appendChild(chart4);
    ...
    function updateDiv() {
        $( "#container10_4" ).load(location.href + " #container10_4" ); 
    }
	
	// eslint-disable-next-line no-unused-vars
	function runTestCase() {
	
		//var line1 = series.createPriceLine({ price: 130 });
		//var line2 = series.createPriceLine({ price: -20 });

		/**/priceLinesArray.forEach(pline => {
			series.createPriceLine(pline);
		});
		...
		return new Promise((resolve) => {
			setTimeout(() => {
                ...
                priceLine.priceLineVisible = false;
				/**/
